// frontend/js/main.js (VERSÃO CORRIGIDA E COMPLETA PARA MOSTRAR DESTINOS)

document.addEventListener('DOMContentLoaded', () => {
    // Mudamos o ID do elemento que vamos procurar
    const destinosGrid = document.getElementById('destinos-grid');

    async function fetchDestinos() {
        try {
            // A URL agora aponta para a nossa nova API de destinos
    ...
    function displayDestinos(destinos) {
        ...
        destinos.forEach(destino => {
            ...
            card.innerHTML = `
                <a href="destino_pacotes.html?id=${destino.id}" class="card-link">
